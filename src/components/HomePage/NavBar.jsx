        ...
        <div className="h-full px-3 py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li>
              <Link
                to="/"
                className="flex items-center p- text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
              ...
              <form className="max-w-md">
                ...
                <div className="relative">
                  ...
                  <input
                    type="search"
                    id="default-search"
                    className="block w-full p-4 ps-10 text-sm text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-black  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <li>
              <span className="ms-3 whitespace-nowrap text-3xl text-white relative top-3 ">
                Discover
              </span>
            </li>
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <span className="flex-1 ms-3 whitespace-nowrap text-3xl text-white ">
                Playlist
              </span>
            </li>
            <div className="ul-child">
              ...
              <li className="text-center text-xs mt-3">
                <span className="text-gray-500 ">
                  Click the button to create a new playlist. You have to be
                  logged in first
                </span>
              </li>
            </div>
